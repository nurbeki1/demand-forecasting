...
function RiskProductsTable({ products, onProductClick }) {
    ...
    return (
      <div className="dashboard-card">
        ...
        <div className="empty-state">
          <span>No high-risk products detected</span>
        </div>
      </div>
    );
  }
          ...
          >
            ...
            <div className="risk-metrics">
              <div className="risk-metric">
                <span className="risk-metric-label">Current Stock</span>
                <span className="risk-metric-value">{product.current_inventory}</span>
              </div>
              <div className="risk-metric">
                <span className="risk-metric-label">7d Demand</span>
                <span className="risk-metric-value">{product.predicted_demand_7d}</span>
              </div>
              <div className="risk-metric">
                <span className="risk-metric-label">Days Left</span>
...
function CategoryInsights({ categories }) {
  return (
    <div className="dashboard-card">
      <div className="card-header">
          ...
          <div key={idx} className={`category-card trend-${cat.trend}`}>
            ...
            <div className="category-stats">
              ...
              <div className="category-stat">
                ...
                <span className="stat-label">Avg Demand</span>
              </div>
              <div className="category-stat">
...
function AIInsightsPanel({ insights, onInsightClick }) {
  const categoryIcons = {
...
function AlertsPanel({ alerts }) {
  ...
  return (
    <div className="dashboard-card alerts-card">
      <div className="card-header">
        <h3>Active Alerts</h3>
        <span className="card-badge warning">{alerts.length} active</span>
      </div>
    ...
    <div className="executive-dashboard">
      ...
      <div className="dashboard-header">
        <div className="header-info">
          ...
          <span className="last-updated">
            Last updated: {data.data_freshness || 'Just now'}
          </span>
        </div>
      ...
      <div className="dashboard-content">
        ...
        <div className="dashboard-column primary">
          ...
          />
          <CategoryInsights categories={data.category_insights} />
        </div>
